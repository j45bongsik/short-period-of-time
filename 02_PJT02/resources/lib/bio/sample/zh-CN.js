...
const serviceInfo = {
    ...
    data: [{
        ...
        cnty_code: "zh-CN",
        chck_date: "20210310",
        pcust_nmbr: "T20210308_02",
    }],
};

/** 테스트용 사용자 키 */
const testUserKeys = [
    "WmJXL1JRUHQ5T3E5aXk4THNyc091ZHhvaEZIbEJmc1BwdHRDWVdGTm1pcjQzNDJoR3BYRnVMbHBOc2owcVVmbjhHcm1OYVN6RU5ySlpCMjNZM3JMQUE9PQ==",
];

/** n번째 테스트용 사용자 키 사용 */
let testUserKey = testUserKeys[0];

/** url 사용 시 apiType을 무시합니다 */
model.apiUrl = "devweb.bizabm.com";
